...
Purpose:         This main file is created to run our air hockey game and make use to imported classes and methods from other files.
                 This main file contains the program for the user interface of the game. From the main menu the user is able to
                 view the rules of the game, exit the program, and select their choice of level. After selecting their level
                 the user will be able to pause the game, resume the game, quit the game, or see the rules during the game.
